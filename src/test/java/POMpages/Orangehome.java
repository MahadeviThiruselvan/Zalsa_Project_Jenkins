...
//	{
//		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Search));
//		Search.sendKeys(data+Keys.ENTER);
//	}
	
	public static void AdminClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Admin));
		Admin.click();
	}
	public static void PIMClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(PIM));
		PIM.click();
	}
	public static void LeaveClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Leave));
		Leave.click();
	}
	public static void TimeClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Time));
		Time.click();
	}
	
	public static void RecruitmentClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Recuitment));
		Recuitment.click();
	}
	
	public static void MyInfoClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(MyInfo));
		MyInfo.click();
	}
	
	public static void PerformanceClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Performance));
		Performance.click();
	}
	
	public static void DashboardClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Dashboard));
		Dashboard.click();
	}
	
	public static void DirectoryClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Directory));
		Directory.click();
	}
	
	public static void MaintenanceClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Maintenance));
		Maintenance.click();
	}
	
	public static void QuestionClick()
	{
		new WebDriverWait(Variables.driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOf(Questionbutton));
